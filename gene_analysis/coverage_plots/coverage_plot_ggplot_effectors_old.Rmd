...
p1 <- ggplot() + 
  geom_point(data = df_subset, aes(x=BASE_TOTAL, y=splitreads, color=EFFECTOR), size=0.1)+
  scale_color_manual(values=c('grey', "#006400"))+
...
ggsave('effectors.tiff', plot=both, width=6.5, height=4, device = 'tiff', dpi = 1000)
```
