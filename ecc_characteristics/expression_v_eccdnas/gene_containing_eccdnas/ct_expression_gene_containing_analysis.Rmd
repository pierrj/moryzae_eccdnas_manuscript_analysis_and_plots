---
title: "ct_expression_gene_containing_analysis"
output:
  html_document:
    df_print: paged
---
...
ggsave("ct_expression_gene_containing_rpkm_plot.pdf", plot = p, width = 6, height = 4)
...
```{r}
pdf(file = "ct_expression_gene_containing_rpkm_diagnostics.pdf", width = 6, height = 4)
par(mfrow=c(2,2))
