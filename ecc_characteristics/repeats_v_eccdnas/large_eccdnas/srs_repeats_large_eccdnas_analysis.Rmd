---
title: "srs_repeats_large_eccdnas_analysis"
...
ggsave("srs_repeats_large_eccdnas_analysis_repeatsper100kb_plot.pdf", plot = p, width = 6, height = 4)
```
...
pdf(file = "srs_repeats_large_eccdnas_analysis_repeatsper100kb_diagnostics.pdf", width = 6, height = 4)
par(mfrow=c(2,2))
plot(lm(df_repeatsper100kb$srs ~ df_repeatsper100kb$repeat_count))
dev.off()
```
...
ggsave("srs_repeats_large_eccdnas_analysis_repeatsper100kbperscaffold_plot.pdf", plot = p, width = 6, height = 4)
```
...
pdf(file = "srs_repeats_large_eccdnas_analysis_repeatsper100kbperscaffold_diagnostics.pdf", width = 6, height = 4)
par(mfrow=c(2,2))
plot(lm(df_repeatsperscaffold$srs ~ df_repeatsperscaffold$repeat_count))
dev.off()
```
