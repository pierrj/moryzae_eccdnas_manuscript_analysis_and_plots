---
title: "if_expression_gene_containing_analysis_infectedsrs"
output:
  html_document:
    df_print: paged
---
...
ggsave("if_expression_gene_containing_rpkm_plot_infectedsrs.pdf", plot = p, width = 6, height = 4)
...
```{r}
pdf(file = "if_expression_gene_containing_rpkm_diagnostics_infectedsrs.pdf", width = 6, height = 4)
par(mfrow=c(2,2))
