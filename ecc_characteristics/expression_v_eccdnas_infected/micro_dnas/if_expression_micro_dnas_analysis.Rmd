---
title: "if_expression_micro_dnas_analysis"
...
ggsave("if_expression_micro_dnas_rpkm_plot.pdf", plot = p, width = 6, height = 4)
...
pdf(file = "if_expression_micro_dnas_rpkm_diagnostics.pdf", width = 6, height = 4)
par(mfrow=c(2,2))
plot(lm(df_rpkm$srs ~ df_rpkm$rpkm))
dev.off()
```