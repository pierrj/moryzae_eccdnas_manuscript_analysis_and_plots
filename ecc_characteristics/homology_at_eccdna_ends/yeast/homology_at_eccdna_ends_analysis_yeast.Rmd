...
hist(df_large_observed$V1)

length(df_large_observed$V1)

length(df_large_observed$V1[df_large_observed$V1 > 10])
...
p <- ggplot(df_large_permuted, aes(x=means)) + 
  ...
  labs(x = "Average length of homology (bp) per permutation", y = "Frequency") +
  theme_classic()
...
df_all_observed <- data.frame(fread('micro_dnas_observed_homology'))

hist(df_all_observed$V1)

length(df_all_observed$V1)

length(df_all_observed$V1[df_all_observed$V1 < 5])/length(df_all_observed$V1)

length(df_all_observed$V1[df_all_observed$V1 < 6 & df_all_observed$V1 >=5])/length(df_all_observed$V1)

length(df_all_observed$V1[df_all_observed$V1 >= 6 ])/length(df_all_observed$V1)


df_all_observed_moryzae <- data.frame(fread('micro_dnas_observed_homology_moryzae'))

hist(df_all_observed_moryzae$V1)

length(df_all_observed_moryzae$V1)

length(df_all_observed_moryzae$V1[df_all_observed_moryzae$V1 < 5])/length(df_all_observed_moryzae$V1)

length(df_all_observed_moryzae$V1[df_all_observed_moryzae$V1 < 6 & df_all_observed_moryzae$V1 >=5])/length(df_all_observed_moryzae$V1)

length(df_all_observed_moryzae$V1[df_all_observed_moryzae$V1 >= 6 ])/length(df_all_observed_moryzae$V1)
...
p <- ggplot(df_large_permuted, aes(x=percent_long_homology)) + 
  ...
  labs(x = "Percentage of regions with more than 10 bp homology per permutation", y = "Frequency") +
  theme_classic()
...
hist(df_micro_observed$V1)

length(df_micro_observed$V1)

length(df_micro_observed$V1[df_large_observed$V1 > 10])
